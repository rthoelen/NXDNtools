...
OUTPUT_HTMLFILE = "/var/www/html/icom.html"
...
def writeout():
	...
	while True:
		...
		outfile.write("<br/><br/><br/><p>")
		outfile.write("<table border='1' style='border-collapse:collapse'><tr><td width='260'><b>Last Heard</b></td><td width='350'><b>User / UID</b></td> \
